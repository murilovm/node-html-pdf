...
function createSection (section, content, options) {
  ...
  return {
    ...
    contents: phantom.callback(function (pageNum, numPages) {
      ...
      var pageNumFinal  = pageNum + (paginationOffset - 1)
      var numPagesFinal = numPages + (paginationOffset - 1)

      if (pageNumFinal + 1 === 1 && !html) html = o.first || c.first
      if (numPagesFinal + 1 === numPages && !html) html = o.last || c.last
